...
const BLOG = {
  ...
  GREETING_WORDS:
    ...
    '曾经的码农,曾经的网管,曾经的网络销售,今天的专职网络干饭人,欢迎您的到来，让我们一起探索网络干饭的方法🎉',
  ...
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.smallstep.one', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '网络创业 网络赚钱 视频制作 被动收入 在线收入 AI工具教程,AI创新,在线赚钱,被动收益策略,视频制作工具,网上创业,免费创业工具,人工智能创业,在线赚钱的实用技巧和方法,AI工具在创业中的应用案例,免费创业工具的推荐和教程,人工智能创新与创业机会', // 网站关键词 英文逗号隔开
  ...
  // 谷歌广告
  ADSENSE_GOOGLE_ID: process.env.NEXT_PUBLIC_ADSENSE_GOOGLE_ID || 'ca-pub-9708421558145743', // 谷歌广告ID e.g ca-pub-xxxxxxxxxxxxxxxx
